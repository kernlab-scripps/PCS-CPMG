...
# At the moment (June, 2018), the PCS potentials can only have one force
# constant per potential. In other words, all PCS values (4*residue) have
# to be added individually so that their force constants can be modulated
